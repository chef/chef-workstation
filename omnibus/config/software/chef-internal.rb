...
version("local_source") do
  puts "PATH: #{File.expand_path("#{project.files_path}/../../components/chef")}"
  source path: File.expand_path("#{project.files_path}/../../components/chef"),
...
build do
  ...
  appbundle "chef-internal", env: env
end
