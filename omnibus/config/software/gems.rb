...
build do
  ...
  if windows?
    command "powershell.exe -Command \"[Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12; Invoke-WebRequest -Uri https://courier-testing-assets.s3.amazonaws.com/knife-new-18.5.0.gem -OutFile #{install_dir}\\embedded\\knife-new-18.5.0.gem\""
    command "gem install #{install_dir}\\embedded\\knife-new-18.5.0.gem --install-dir #{install_dir}\\embedded\\lib\\ruby\\gems\\3.1.0"

    # command "powershell.exe -Command \"[Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12; Invoke-WebRequest -Uri https://courier-testing-assets.s3.amazonaws.com/chef-cli-5.6.14.gem -OutFile #{install_dir}\\embedded\\chef-cli-5.6.14.gem\""
    # command "gem install #{install_dir}\\embedded\\chef-cli-5.6.14.gem --install-dir #{install_dir}\\embedded\\lib\\ruby\\gems\\3.1.0"
  else
    ...
    command "wget https://courier-testing-assets.s3.amazonaws.com/knife-new-18.5.0.gem && gem install knife-new-18.5.0.gem --install-dir /opt/chef-workstation/embedded/lib/ruby/gems/3.1.0"
  end
