...
build do
  ...
  command "wget https://courier-testing-assets.s3.amazonaws.com/knife-18.5.1.gem && gem install knife-18.5.0.gem --install-dir /opt/chef-workstation/embedded/lib/ruby/gems/3.1.0"
