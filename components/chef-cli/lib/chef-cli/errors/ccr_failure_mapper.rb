...
module ChefCLI::Errors
  class CCRFailureMapper
    ...
    class RemoteChefClientRunFailed < ChefCLI::ErrorNoLogs
      def initialize(id, *args); super(id, *args); end
    end

    class RemoteChefClientRunFailedUnknownReason < ChefCLI::ErrorNoStack
      def initialize(); super("CHEFCCR099"); end
    end

    class RemoteChefRunFailedToResolveError < ChefCLI::ErrorNoStack
