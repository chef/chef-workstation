...
require "chef-cli/command/target"
...
module ChefCLI
  module Command
    class Target
      class Converge < ChefCLI::Command::Base
        T = ChefCLI::Text.commands.target.converge
        TS = ChefCLI::Text.status
        ...
        option :ssl,
          :long => "--[no-]ssl",
          :short => "-s",
          :description => T.ssl.desc(ChefCLI::Config.connection.winrm.ssl),
          :boolean => true,
          :default => ChefCLI::Config.connection.winrm.ssl

        option :ssl_verify,
          :long => "--[no-]ssl-verify",
          :short => "-s",
          :description => T.ssl.verify_desc(ChefCLI::Config.connection.winrm.ssl_verify),
          :boolean => true,
          :default => ChefCLI::Config.connection.winrm.ssl_verify

        option :cookbook_repo_paths,
          :long => "--cookbook-repo-paths PATH",
          :description => T.cookbook_repo_paths.desc,
          :default => ChefCLI::Config.chef.cookbook_repo_paths,
