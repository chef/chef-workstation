...
RSpec.describe ChefCLI::Errors::CCRFailureMapper do
  let(:cause_line) { nil }
  ...
  subject { ChefCLI::Errors::CCRFailureMapper.new(cause_line, params) }
  ...
  describe "#raise_mapped_exception!" do
    context "when no cause is provided" do
      ...
      it "raises a RemoteChefRunFailedToResolveError" do
        expect { subject.raise_mapped_exception! }.to raise_error(ChefCLI::Errors::CCRFailureMapper::RemoteChefRunFailedToResolveError)
    ...
    context "when a cause is provided" do
      context "but can't resolve it" do
        ...
        it "raises a RemoteChefClientRunFailedUnknownReason" do
          expect { subject.raise_mapped_exception! }.to raise_error(ChefCLI::Errors::CCRFailureMapper::RemoteChefClientRunFailedUnknownReason)
        end
      end
      ...
      context "and can resolve the cause" do
        ...
        it "raises a RemoteChefClientRunFailed" do
          expect { subject.raise_mapped_exception! }.to raise_error(ChefCLI::Errors::CCRFailureMapper::RemoteChefClientRunFailed)
        end
      end
    end
  end
