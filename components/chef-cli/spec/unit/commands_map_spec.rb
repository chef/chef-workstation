...
RSpec.describe ChefCLI::CommandsMap do
  ...
  it "creates an instance of a command" do
    expect(mapping.instantiate("example")[0]).to be_an_instance_of(ChefCLI::Command::TestCommand)
  end

  it "creates an instance of the correct command when an alias is used" do
    expect(mapping.instantiate("subby")[0]).to be_an_instance_of(ChefCLI::Command::AliasedCommand)
  end
