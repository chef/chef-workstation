...
git commit --message "Bump Delivery CLI to $version" --message "This pull request was triggered automatically via Expeditor when Delivery CLI $version was merged to main." --message "This change falls under the obvious fix policy so no Developer Certificate of Origin (DCO) sign-off is required."
