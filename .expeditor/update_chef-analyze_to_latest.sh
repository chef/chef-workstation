...
git commit --message "Bump chef-analyze CLI to $version" --message "This pull request was triggered automatically via Expeditor when chef-analyze $version was merged to master." --message "This change falls under the obvious fix policy so no Developer Certificate of Origin (DCO) sign-off is required."
