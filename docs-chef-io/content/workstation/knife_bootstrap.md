...
- knife bootstrap does not support an option to provide passphrases for private SSH keys. Use an unencrypted private key instead. This will also help with unattended bootstraps.
